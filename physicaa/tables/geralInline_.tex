\begin{table}[h!]
\begin{center}
\caption{Participants, messages and threads among each Erd\"os sector: ({\bf p.} for periphery, {\bf i.} for intermediary, 
	...
	while $\mu$ and $\sigma$ denote mean and standard deviation. TAG of list: 10}\label{geralListas}    
